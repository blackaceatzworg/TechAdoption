 ...
 * 
 * @param I - the type used to identify and organize Actions in this domain
 * @param A - the type of Action this domain manages 
 * 
...
public interface ActionDomain<I, A extends Action>{
	...
	/**
	 * Retrieves the Action indicated by the id object. Should return null if the 
	 * id does not match an existing Action.
	 *  
	 * @param id - identifier indicating the desired Action

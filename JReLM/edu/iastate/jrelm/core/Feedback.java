 ...
 * 
 * Feedback may be simple, such as a single reward value resulting from the 
 * last action chosen, or more complicated, such as a weighted reward 
 * distribution over a recent history of multiple action choices. The Feedback
 * interface allows us to build appropriately complex classes for different 
 * types of feedback.
 *
 * 

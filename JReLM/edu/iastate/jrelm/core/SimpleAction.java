 ...
 * around a given object specifying or containing information required for 
 * an operation the agent may peform in the simulation environment. In other 
 * words, the object represents a course of action in the world and 
 * SimpleAction acts as a wrapper to make it compatible with other JReLM 
 * components.
 * 
 * @param <O> - the type of object being use to represent a course of action. 
...
public class SimpleAction<O> implements Action<Integer>{
	 ...
	 * 
	 * @param id - identifier for this action
	 * @param activity - object representing an action or operation an agent 
	 * 					 can perform in the simulation model.
	 */

...
import edu.iastate.jrelm.core.SimpleAction;
	 ...
	 * SimpleActions that wrap a given collection of Objects that represent
	 * action choices. 
	 * <P>
	 * This domain builds itself from a given collection of Objects. Each Object 
	 * is considered to represent a choice of action and the Collection the list
	 * of all possible actions an ReinforcementLearner can choose from. 
	 * Internally, each Object is wrapped in SimpleAction and the space of possible
	 * actions is organized by Integer index. The use of SimpleAction wrappers allow 
	 * the domain to be used with other learning components (i.e. ReinforcementLearner,
	 * StatelessPolicy). 
	 *<P>
	 * 
	 * @param <O> - This is the original type of action Objects in
	 * 				the given collection.
	 */
	public class SimpleActionDomain<O> 
			implements ActionDomain<Integer, SimpleAction<O>>{
		 ...
		 * @param actions - list of objects specifying actions. 
		 */
		 ...
		 * 
		 * @param actionIndex - int index of the desired action in the domain
		 * @return - the desired action (note: the original object is wrapped in 
		 * 			 a SimpleAction)
		 */

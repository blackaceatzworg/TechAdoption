...
/**
 * Representation of an agent's state space. That is, the collection of world states
 * that an agent may encounter in an environment.   
 * 
 * The type of State as well as state identifier may be paramertized. These 
 ...
 * 
 * @param I - the type used to identify and organize States in this domain
 * @param S - the type of State this domain manages 
 * 
...
public interface StateDomain<I, S extends State> {
	...
	/**
	 * Retrieves the State indicated by the id object. Should return null if the id 
	 * does not match an existing Action.
	 *  
	 * @param id - identifier indicating the desired State

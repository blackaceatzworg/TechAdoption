 ...
 * 
 * @param I - the type of action identifier used by the ActionDomain given to 
 * 			  this policy
 * @param A - the type of Action managed by the ActionDomain given to this 
 * 			  policy
 *
 */
public abstract class AbstractStatelessPolicy
		<I, A extends Action> 
	 ...
	 */
	public StateDomain<Object, State> getStateDomain() {return null;}

 ...
 * 
 * This class takes care of most of the ho-hum functionality that will likely
 * be common to most statless ReinforcementLearner classes. Child classes will 
 * be free to focus on implementing the specifics of thier particular learning
 * algorithms.
 * 
 * @author Charles Gieseler
 *
 * @param <PA> - the type of ReinforcementLearner parameters this learner accepts
 * @param <I> - the type of identifier being used to distiguish Actions
 * @param <A> - the type of Actions this learner is working with
 * @param <F> - the type of Feedback that this learner accepts 
 * @param <PO> - the type of Policy that this learner updates and uses make new
 * 				Action selections
 */
public abstract class AbstractStatlessLearner 
	   <PA extends RLParameters,
		I, 
		A extends Action<I>,
		F extends Feedback,
		PO extends StatelessPolicy<I,A>> 
	...
	/**
	 * Construct an learning component with parameters specified in a
	 * PA and the given SimpleStatelessPolicy. 
	 * 
	 ...
	 * 						this AbstractStatlessLearner
	 * @param aPolicy - a SimpleStatelessPolicy
	 */
	public AbstractStatlessLearner(
			PA learningParams, 
			PO aPolicy){
	 ...
	 * choice on.
	 * 
	 * IMPORTANT: It should be noted that this method also checks to see if 
	 * this learner's parameters have changed and takes appropriate action.
	 * Specifically, it checks to see if the random seed has changed and, if 
	 * so, updates the learner's policy with the new setting. 
	 * 
	 ...
	 * accepting them (PA.validate()). If the parameters fail 
	 * validation, the old settings will be used and the new settings will be 
	 * ignored.
	 * 

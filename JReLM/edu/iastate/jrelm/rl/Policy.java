 ...
 * 
 * Since a policy maps between States and Actions and may assign values to States, Actions, 
 * or State-Action pairs, it should operate over a given ActionDomain and StateDomain.  
 * 
 * @author Charles Gieseler
 *
 * @param AI - the type of Action identifier used in the ActionDomain given to this 
 * 			   policy
 * @param A -  the type of Action managed by the ActionDomain given to this policy
 * @param SI - the type of State identifier used in the StateDomain given to this 
 * 			   policy
 * @param S -  the type of State managed by the StateDomain given to this policy
 */
public interface Policy<AI, A extends Action, SI, S extends State>{

	/**
	 * Given the current State as indicated by the stateID, choose a 
	 * new Action according to the current policy.
	 * 
	 ...
	 *  
	 * @param actionID - the identifier of the desired Action in the ActionDomain
	 * @param stateID - the identifier of the desired State in the StateDomain
	 * @return the probability of choosing the specified Action from the given State. 
	 * Should return Double.NaN if actionID or stateID are do not point to elements in the 
	 * respective domains.   
	 */
	 ...
	 * @param stateID - the identifier of the desired State in this policy's StateDomain.
	 * @param newValue - new choice probability value to associate with this action-state pair.
	 */

...
public interface RLParameters  {
	 ...
	 * learners. 
	 * 
	 * Random seeds need to be included as learner parameters to 
	 * facilitate the assignment of separate seeds to individual learners. 
	 * This is necessary for certain situations where variations in behavior 
	 * accross learners needs to be forced. For example, learners embedded in 
	 * separate agents will likely need different seeds to avoid identical 
	 * starting behavior, unless they are intialized with policies.
	 * 
	 * @return
	 */

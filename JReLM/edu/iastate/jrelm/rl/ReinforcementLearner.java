 ...
 * driving the learning process of specific algorithms.
 * 
 * Reinforcement learning algorithms make use of a policy to represent 
 * learned knowledge. Policies themselves require access to the space of possible
 ...
 *
 * @param <PA> - the type of ReinforcementLearner parameters (RLParameters) 
 * 				 this learner accepts. This will usually be a specific set of 
 * 				 paramters needed for a particular learning algorithm.
 * @param <I> - the type of identifier being used to distiguish Actions
 * @param <A> - the type of Actions this learner is working with
 * @param <F> - the type of reinforcement object (Feedback) that this learner accepts 
 * @param <PO> - the type of Policy that this learner updates and uses make new
 * 				Action selections
 *
 */

public interface ReinforcementLearner
		<PA extends RLParameters, 
		 I, 
		 A extends Action, 
		 F extends Feedback, 
		 PO extends Policy> {
	 ...
	 * with a the last Action chosen by this leaner and is treated as a 
	 * reinforcement value for that Action. Feedback used to update the 
	 * probability of choosing Actions in the learner's Policy according to the
	 * specific learning algorithm implemented. 
	 * <P>
	 * Note: Most often feedback is for the last Action chosen, so given ActionID 
	 * will usually point to this Action. As such, many RLEnigine implementations
	 * may also provide update() methods that simply accept feedback and associate 
	 * it with the last Action chosen.
	 * 
	 * @param reward - feedback for the specified action
	 */
	 ...
	 * 
	 * @return learning parameters compatible with this learner, initialized 
	 * to default settings. 
	 */
	 ...
	 *
	 * @param parameters - new settings for this algorithm as RLParameters
	 */
	 ...
	 * 
	 * @return the Policy being used by this ReinforcementLearner. The policy can be any object
	 * 		   implementing the StatelessPolicy interface.
	 ...
	 * 
	 * @param p - The policy can be any object implementing the StatelessPolicy interface.
	 * @see edu.iastate.jrelm.rl.StatelessPolicy
	 */

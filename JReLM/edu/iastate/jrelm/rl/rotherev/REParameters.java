 ...
 * 
 * 	Experiementation: --explaination pending--
 ...
 *
 */
public class REParameters implements RLParameters {
...
//	private int numberOfActions = -1;
	...
	/**
	 *  The degree to which actions are "forgotten". Used to degrade the propensity 
	 *  for choosing actions. Meant to make recent experience more prominent than past
	 *  experience in the action choice process. 
	 * 
	 */
	...
	/**
	 * Seed value for the random event generator used in the policy
	 * Setting the seed to null forces VREParameters.getSeed() to 
...
//		TODO: Actually handle case of invalid parameters 		
	...
	/**
	 * Additional parameters.
	 * Specify a seed for the psuedo-random number generator used by REPolicy
	 * and temperture value for use in a Gibb-Boltzmann probabilty 
	 * distribution. The learner will use this distribution in selecting new 
	 * action choices, rather than the default proportional distribution. 
	 *  
	 * @param boltzmannCooling
	...
	/**
	 * Indicate whether to use the Gibbs-Boltzmann probability 
	 * distribution or default to the proportional distribution. 
	 */
	...
	/**
	 * @param bTemp Sets the value of the scaling paremeter.
	 */
	...
	/**
	 * @param recency Sets the value of the recency parameter.
	 */
	...
	/**
	 * Get the seed for the RandomEngine used in the REPolicy. If 
	 * the seed has not been set, this will return (int)System.currentTimeMillis().
	 * 

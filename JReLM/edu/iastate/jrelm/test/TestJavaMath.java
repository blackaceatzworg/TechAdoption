...
System.out.println("TestJavaMath");
		...
		for (int k=0; k < 20; k++){doubleSum = doubleSum + 0.05;}
System.out.println("doubleSum = " + doubleSum);
	
		int intSum = 0;
		for (int k=0; k < 20; k++){intSum = intSum + 1;}
...
System.out.println(floatSum);
		floatSum = 0;
		for (int k=0; k < 20; k++){floatSum = floatSum + (float)0.0500;}
System.out.println("floatSum = " + floatSum);
		...
		for (int k=0; k < 20; k++){bdSum = bdSum.add(bd);}

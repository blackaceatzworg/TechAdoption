...
public class TestModifiedEmpiricalWalker_UniformDistribution extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		walker = new ModifiedEmpiricalWalker(pdf, ModifiedEmpiricalWalker.NO_INTERPOLATION, twister);
	}
...
out.println("	aciton: "+k+"  probability: "+walker.pdf(k)+"  frequency: "+frequencies[k]);

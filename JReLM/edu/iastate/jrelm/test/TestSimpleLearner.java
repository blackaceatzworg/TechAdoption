...
public class TestSimpleLearner extends TestCase {
	...
	public void testSetParameters(){
		...
		VREParameters newParams1 = new VREParameters(128486803, 0.452, 500, 0.23);
		learner.setParameters(newParams1);
		
		assertNotSame(oldParams, learner.getParameters());
		assertSame(newParams1, learner.getParameters());
		
		AREParameters newParams2 = 
			new AREParameters(128486803, 0.452, 500, domain.size(), 0.23);
...
//out.println("TestSimpleLearner.testSetPolicyIncompatible:");		
		...
		SimpleStatelessPolicy<Integer, SimpleAction<String>> newPolicy = 
			new SimpleStatelessPolicy<Integer, SimpleAction<String>>(domain);

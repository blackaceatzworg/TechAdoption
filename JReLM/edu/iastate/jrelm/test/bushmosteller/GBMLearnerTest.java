 ...
 *
 */
public class GBMLearnerTest 
		extends AbstractStatlessLearnerTest<LinearGBMParameters, 
											Double> {
	...
	protected void setUp() throws Exception {
		...
		GBMLearner<Integer, SimpleAction<Integer>> newLearner = 
				new GBMLearner<Integer, SimpleAction<Integer>>(getParameters(), getPolicy());

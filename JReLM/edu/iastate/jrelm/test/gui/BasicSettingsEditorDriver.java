...
/*	public static void main(String[] args) {
		...
		LinearSpillover linSpill = new LinearSpillover(new SimpleDissimilarity(), -5);
		LogarithmicSpillover logSpill = new LogarithmicSpillover(new SimpleDissimilarity(), 0.5, 0.6, 0.7);

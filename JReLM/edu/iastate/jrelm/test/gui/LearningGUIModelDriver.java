...
import edu.iastate.jrelm.rl.RLParameters;import edu.iastate.jrelm.rl.rotherev.advanced.AREParameters;
...
public class LearningGUIModelDriver extends SimpleModel{
	...
	public void initRLGUI() {
		...
		ExponentialSpillover<Action,FakeDissimilarity> expSpill = 
			new ExponentialSpillover<Action, FakeDissimilarity>(measure, -1);
		
		LogarithmicSpillover<Action,FakeDissimilarity> logSpill = 
			new LogarithmicSpillover<Action, FakeDissimilarity>(measure, -1, 0.4, 0.5);
		
		LinearSpillover<Action,FakeDissimilarity> linSpill = 
			new LinearSpillover<Action, FakeDissimilarity>(measure, -1);
...
//		JReLMController_Mark1 controller = new JReLMController_Mark1(descripts); 
//		JReLMController_Mark1 controller = new JReLMController_Mark1(parameters);
		
//		JReLMSettingsController_Mark2 controller = new JReLMSettingsController_Mark2(parameters);
		JReLMSettingsController_Mark2 controller = new JReLMSettingsController_Mark2(descripts);

 ...
 *
 * @param <PA> - specific type of parameters used for the test
 * @param <R> - reward feedback type that should be used
 */
public abstract class AbstractStatlessLearnerTest<PA extends RLParameters,
												  R> extends TestCase {
	...
	private AbstractStatlessLearner<PA, 
									Integer, 
									SimpleAction<Integer>, 
									Feedback<R>, 
									SimpleStatelessPolicy<Integer, SimpleAction<Integer>>> learner;
	...
	protected void setUp() throws Exception {
		...
		policy = new SimpleStatelessPolicy<Integer, SimpleAction<Integer>>(actionDomain);
	...
	/**
	 * Should be overriden to test functionality specific to individual 
	...
	public AbstractStatlessLearner<PA, 
								   Integer, 
								   SimpleAction<Integer>, 
								   Feedback<R>, 
								   SimpleStatelessPolicy<Integer, 
								   SimpleAction<Integer>>> getLearner() {
		return learner;
	}

	public void setLearner(
			AbstractStatlessLearner<PA, 
									Integer, 
									SimpleAction<Integer>, 
									Feedback<R>, 
									SimpleStatelessPolicy<Integer, 
									SimpleAction<Integer>>> learner) {

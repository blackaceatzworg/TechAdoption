 ...
 * other words, these test check to see that the RELearner behaves in 
 * accordance with the Roth-Erev algorithm. 
 * 
...
//}
		...
		params = new REParameters(
				...
				RECENCY,
				112358);
		policy = new REPolicy<Integer, SimpleAction<String>>(domain, randomGenerator);
	...
	public void testLearningProcess(){
		...
		/* First 6 random numbers generated from a MersenneTwister with seed 112358
		 
			0.47964709435068315 -- First choice start from uniform, so ignore
			
			0.8121422842891705
			0.011851526708644866
			0.7568290174136303
			0.5973060739047057
			0.9757808769921001
...
System.out.println();
		/*
		 	FIRST INFORMED CHOICE
		 	Values after last update according to hand 
		 	calculation of the Roth-Erev algorithm
		 	
		 	Propensities after update
		 	choice 0: 393.333333333333333333333333333333
		 	choice 1: 460.0
		 	choice 2: 393.333333333333333333333333333333
		 	choice 3: 393.333333333333333333333333333333
		 	
		 	Probabilities after update
		 	choice 0: 0.23983739837398373983739837398387
		 	choice 1: 0.28048780487804878048780487804895
		 	choice 2: 0.23983739837398373983739837398387
		 	choice 3: 0.23983739837398373983739837398387
		
			With random value 0.8121422842891705, should
			choose 3 using simple, subtractive 
			probability method used in SimpleEventGenerator.
		*/
		newChoice = learner.chooseAction();
		...
		/*
		 	...
		 	Propensities
		 	224.199999999999999999999999999999
		 	305.533333333333333333333333333333
		 	224.199999999999999999999999999999
		 	294.199999999999999999999999999999
		 	
		 	Probabilities
			0.21390408344994275537463427044902
			0.29150235339015392443709451723705
			0.21390408344994275537463427044902
			0.2806894797099605648136369418649

			Rand value: 0.011851526708644866
			Choosen Next: 0
		 */
...
System.out.println();		
		...
		/*
		 	...
		 	Propensities
		 	145.293999999999999999999999999999
		 	184.987333333333333333333333333333
		 	138.627333333333333333333333333333
		 	178.527333333333333333333333333333
		 	
		 	Probabilities
			0.22441445949869948535453697353865
			0.28572296463794619596891945046829
			0.21411743142694155612807031634534
			0.27574514443641276254847325964788
			
			Rand value: 0.7568290174136303
			Choosen Next: 3
		*/	
...
System.out.println();		
		...
		/*
			...
			Propensities
			77.400913333333333333333333333276
			100.02611333333333333333333333331
			73.600913333333333333333333333314
			93.010579999999999999999999999999
			
			Probabilities
			0.22558223087390787963811557939355
			0.29074102903748491108884885376754
			0.21393218798096600733353233811455
			0.27034932018658840876308096833574
			
			Rand value: 0.5973060739047057
			Choosen Next: 2
		*/
...
System.out.println();		
		...
		/*
			...
			Propensities
			369.11852059999999999999999999996
			382.01488459999999999999999999998
			1091.9525206
			378.01603059999999999999999999999
					
			Probabilities
			0.16618711245397919726041082334534
			0.17199340331912374340025591451956
			0.49162647282066029159434763172247
			0.17019301140623676774498563041294
			
			Rand value: 0.9757808769921001
			Choosen Next: 3
	    */

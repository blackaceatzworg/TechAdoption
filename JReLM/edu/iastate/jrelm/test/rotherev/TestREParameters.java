...
public class TestREParameters extends TestCase {
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.REParameters()'
	 */
	public void testREParameters() {
		...
		assertEquals(params.getExperimentation(), REParameters.DEFAULT_EXPERIMENTATION);
		assertEquals(params.getInitialPropensity(), REParameters.DEFAULT_INIT_PROPENSITY);
		assertEquals(params.getRecency(), REParameters.DEFAULT_RECENCY);
		assertNotNull(params.getRandomSeed());
	}

	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.REParameters(double, double, double, double)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.REParameters(double, double, double, double, int)'
	 */
	public void testREParametersDoubleDoubleDoubleDoubleInt() {
		params = new REParameters(testBoltz, testExp, testInitProp, testRecency, testSeed);
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.validateParameters()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getBoltzmannTemp()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.setBoltzmannTemp(double)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getExperimentation()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.setExperimentation(double)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getInitialPropensity()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.setInitialPropensity(double)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.setRecency(double)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getRandomSeed()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.setRandomSeed(int)'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getParameterNames()'
	 */
	...
	/*
	 * Test method for 'edu.iastate.jrelm.rl.rotherev.REParameters.getParameterDescriptors()'
	 */

...
//	System.out.println("	"+ prop);		
		...
		*/
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2540969, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2377094, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2540969, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2540969, 0.000001));
		...
		/*
			...
			Choosen Next: 0
		 */
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2712644, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2574047, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2712644, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2000665, 0.000001));
		...
		/*
			...
			Choosen Next: 3
		*/		
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.1190774, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.3077682, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.3207312, 0.000001));
		assertTrue(within(learner.getPolicy().getPropensity(0), 0.2524232, 0.000001));
